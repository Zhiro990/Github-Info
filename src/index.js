...
class GitHubInfo {
	...
	async getRepo(owner, name) {
		...
		const response = await this._request("/repos/" + owner + "/" + name);
	...
	async getUser(name) {
		...
		const response = await this._request("/users/" + name);
	...
	async getUserRepos(name) {
		...
		const response = await this._request("/users/" + name + "/repos");
	...
	async getUserStarredRepos(name) {
		...
		const response = await this._request("/users/" + name + "/starred");
	...
	async getUserSocialAccounts(name) {
		...
		const response = await this._request("/users/" + name + "/social_accounts");
